...
public enum SoundEffects {
    ...
    public void setContext(Context context) {
        ...
        mSoundPoolMap.put(SOUND_EXPLOSION, mSoundPool.load(mContext, R.raw.explosion,1));
        // TODO Add sounds corresponding to the bullet and Android Guy
        mSoundPoolMap.put(SOUND_GUY,mSoundPool.load(mContext,R.raw.beep4,1));
        mSoundPoolMap.put(SOUND_BULLET,mSoundPool.load(mContext, R.raw.beep9,1));
